...
namespace model {
	...
	/// @brief Contains the model of a SPOT robot
	///
	/// Efficiency-based planning for SPOT robots, with the ability to
	...
	/// state[0]; // x position
	/// state[1]; // y position
	/// state[2]; // heading angle theta
	/// state[3]; // x linear velocity
	/// state[4]; // y linear velocity
	/// state[5]; // x angular velocity
	/// state[6]; // y angular velocity
	/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	/// # Model controls
	/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{cpp}
	/// control[0]; // x linear velocity of the robot
	/// control[1]; // y linear velocity of the robot
	/// control[2]; // turn angle theta of the robot
	/// control[3]; // height of robot (offset from default height)
	/// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	class SpotModel : public Model {
	public:
		SpotModel();
		SpotModel(const json&);
		~SpotModel();
		...
		/// @brief serialize `SpotModel` values into json
		///
		/// # Example
